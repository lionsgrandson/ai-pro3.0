...
import { calibration_img_url, engineering_img_url, holistic_img_url, low, repair_img_url, validation_img_url } from "../../assets";
...
export default function Home() {
  ...
  return (
      <div className="d-flex flex-column align-items-center col-12">
        ...
        <Suspense fallback={<div style={{width:"100vmin",height:"100vmin"}}></div>}>
        ...
        >
          <h2 className="test1">{t("titel 5 carsd")}</h2>
        </div>
